                    ...
                    <ul className="nav">
                        <li className="nav-item">
                            <a className="nav-link" href="/">
                                <HomeRoundedIcon sx={{ fontSize: 20, marginInline: 1.5 }} />
                                <span className="menu-title">Dashboard</span>
                            </a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="/user">
                                <PersonRoundedIcon sx={{ fontSize: 20, marginInline: 1.5 }} />
                                <span className="menu-title">Admin</span>
                            </a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="/menu">
                                <RestaurantRoundedIcon sx={{ fontSize: 20, marginInline: 1.5 }} />
                                <span className="menu-title">Menu</span>
                            </a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="/meja">
                                <TableBarRoundedIcon sx={{ fontSize: 20, marginInline: 1.5 }} />
                        ...
                        <li className="nav-item">
                            <a className="nav-link" data-toggle="collapse" href="#cart" aria-expanded="false" aria-controls="auth">
                                <ShoppingCartRoundedIcon sx={{ fontSize: 20, marginInline: 1.5 }} />
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="/transaksi">
                                <AttachMoneyRoundedIcon sx={{ fontSize: 20, marginInline: 1.5 }} />
                                <span className="menu-title">Transaction</span>
                            </a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="/laporan">
                                <LocalPrintshopRoundedIcon sx={{ fontSize: 20, marginInline: 1.5 }} />
                                <span className="menu-title">Generate</span>
                            </a>
                        </li>
                    </ul>
                </nav>
