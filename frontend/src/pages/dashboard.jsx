                                                                        ...
                                                                        <div className="table-responsive mb-3 mb-md-0 mt-3">
                                                                            <table className="table table-borderless report-table">
                                                                                <tr>
                                                                                    ...
                                                                                    <td className="w-100 px-0">
                                                                                        <div className="progress progress-md mx-4">
                                                                                            <div className="progress-bar bg-primary" role="progressbar" width="70%" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                                                                                        </div>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td className="w-100 px-0">
                                                                                        <div className="progress progress-md mx-4">
                                                                                            <div className="progress-bar bg-warning" role="progressbar" width="30%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                                                                                        </div>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td className="w-100 px-0">
                                                                                        <div className="progress progress-md mx-4">
                                                                                            <div className="progress-bar bg-danger" role="progressbar" width="95%" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100"></div>
                                                                                        </div>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td className="w-100 px-0">
                                                                                        <div className="progress progress-md mx-4">
                                                                                            <div className="progress-bar bg-info" role="progressbar" width="60%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                                                                        </div>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td className="w-100 px-0">
                                                                                        <div className="progress progress-md mx-4">
                                                                                            <div className="progress-bar bg-primary" role="progressbar" width="40%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                                                                        </div>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td className="w-100 px-0">
                                                                                        <div className="progress progress-md mx-4">
                                                                                            <div className="progress-bar bg-danger" role="progressbar" width="75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                                                                                        </div>
                                                                                    </td>
                                                ...
                                                <div className="card-body">
                                                    ...
                                                    <div className="charts-data">
                                                        <div className="mt-3">
                                                            ...
                                                            <div className="d-flex justify-content-between align-items-center">
                                                                <div className="progress progress-md flex-grow-1 mr-4">
                                                                    <div className="progress-bar bg-inf0" role="progressbar" width="95%" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100"></div>
                                                                </div>
                                                        ...
                                                        <div className="mt-3">
                                                            ...
                                                            <div className="d-flex justify-content-between align-items-center">
                                                                <div className="progress progress-md flex-grow-1 mr-4">
                                                                    <div className="progress-bar bg-info" role="progressbar" width="35%" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100"></div>
                                                                </div>
                                                        ...
                                                        <div className="mt-3">
                                                            ...
                                                            <div className="d-flex justify-content-between align-items-center">
                                                                <div className="progress progress-md flex-grow-1 mr-4">
                                                                    <div className="progress-bar bg-info" role="progressbar" width="48%" aria-valuenow="48" aria-valuemin="0" aria-valuemax="100"></div>
                                                                </div>
                                                        ...
                                                        <div className="mt-3">
                                                            ...
                                                            <div className="d-flex justify-content-between align-items-center">
                                                                <div className="progress progress-md flex-grow-1 mr-4">
                                                                    <div className="progress-bar bg-info" role="progressbar" width="25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                                                </div>
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="row">
                                                <div className="col-12">
                                                    <div className="table-responsive">
                                                        <table id="example" className="display expandable-table" width="100%">
                                                            <thead>
                                                                <tr>
                                                                    <th>Quote#</th>
                                                                    <th>Product</th>
